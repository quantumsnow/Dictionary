...
import com.flowsnake.dictionary.logic.Controller;

import java.util.List;

public class MainActivity extends AppCompatActivity implements ResultsFragment.OnFragmentInteractionListener {
...
//    }
    ...
    public class HistoryPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return ResultsFragment.newInstance(history.get(position));
        }
